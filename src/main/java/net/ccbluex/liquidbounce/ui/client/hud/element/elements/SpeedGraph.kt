...
class SpeedGraph(
    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        if (LiquidBounce.theme == "Custom") {
            RenderUtils.drawRect(0f, 0f, width.toFloat(), 1f, HUD.getClientCustomColor().rgb)
        } else RenderUtils.drawGradientSideways(0F, 0F, width.toFloat(), 1F, ColorUtils.hslRainbow(10, indexOffset = 30).rgb, ColorUtils.hslRainbow(10, indexOffset = 60).rgb)
