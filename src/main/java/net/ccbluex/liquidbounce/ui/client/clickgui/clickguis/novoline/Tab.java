...
public class Tab {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Fonts.fontIcon2.drawString(l, posX + 88, posY + 5, 0xffffffff);
        Fonts.fontBaloo40.drawString(enumModuleType.name().charAt(0) + enumModuleType.name().substring(1).toLowerCase(), posX + 4, posY + 4, 0xffffffff, true);
        if (opened) {
