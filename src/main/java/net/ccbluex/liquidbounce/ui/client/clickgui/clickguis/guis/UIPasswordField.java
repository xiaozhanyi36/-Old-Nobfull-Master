...
public final class UIPasswordField extends Gui {
    ...
    public GameFontRenderer fontRendererInstance;
    public int width;
    public int height;
    ...
    public UIPasswordField(final GameFontRenderer p_i1032_1_, final int p_i1032_2_, final int p_i1032_3_, final int p_i1032_4_, final int p_i1032_5_) {
        super();
    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            ...
            if (!isFocused() && getText().isEmpty())
                Fonts.font35.drawString("Password", xPosition + 5, yPosition + 9, new Color(180, 180, 180).getRGB());
    ...
    public int func_146183_a(final int p_146183_1_) {
    ...
    public void func_146191_b(final String p_146191_1_) {
        ...
        final int var4 = Math.min(this.field_146224_r, this.field_146223_s);
        final int var5 = Math.max(this.field_146224_r, this.field_146223_s);
    ...
    public String func_146207_c() {
        final int var1 = Math.min(this.field_146224_r, this.field_146223_s);
        final int var2 = Math.max(this.field_146224_r, this.field_146223_s);
