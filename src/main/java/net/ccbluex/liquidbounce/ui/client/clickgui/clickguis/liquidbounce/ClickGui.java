...
package net.ccbluex.liquidbounce.ui.client.clickgui.clickguis.liquidbounce;
...
import net.ccbluex.liquidbounce.ui.client.clickgui.clickguis.liquidbounce.elements.Element;
import net.ccbluex.liquidbounce.ui.client.clickgui.clickguis.liquidbounce.elements.ModuleElement;
import net.ccbluex.liquidbounce.ui.client.clickgui.clickguis.liquidbounce.style.Style;
import net.ccbluex.liquidbounce.ui.client.clickgui.clickguis.liquidbounce.style.styles.NormalStyle;
...
public class ClickGui extends GuiScreen {
    ...
    public Style style = new NormalStyle();
    ...
    public ClickGui() {
        ...
        for (final ModuleCategory category : ModuleCategory.values()) {
            panels.add(new Panel(category.getDisplayName(), category, xPos, 10, width, height, false) {
    ...
    public void onGuiClosed() {
        LiquidBounce.fileManager.saveConfig(LiquidBounce.clickGuiConfig);
    }
