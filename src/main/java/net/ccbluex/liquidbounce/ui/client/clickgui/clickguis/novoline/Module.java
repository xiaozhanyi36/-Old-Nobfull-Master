...
public class Module {
    ...
    public Module(net.ccbluex.liquidbounce.features.module.Module module, Tab tab) {
        this.module = module;
        this.tab = tab;
        for (net.ccbluex.liquidbounce.ui.client.clickgui.clickguis.novoline.setting.Setting setting : Manager.getSettingsByMod(module)) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Fonts.fontBaloo35.drawString(module.getName(), tab.getPosX() + 2, (float) (y + 4), 0xffffffff, true);
