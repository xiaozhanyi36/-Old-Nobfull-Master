...
public class UITextField extends Gui {
    ...
    public UITextField(int componentId, GameFontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (!isFocused && text.isEmpty())
                Fonts.font35.drawString("UserName", xPosition + 5, yPosition + 9, new Color(180, 180, 180).getRGB());
