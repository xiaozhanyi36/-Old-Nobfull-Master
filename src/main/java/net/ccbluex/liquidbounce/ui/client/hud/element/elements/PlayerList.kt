...
import net.ccbluex.liquidbounce.utils.render.ColorUtil1
import net.ccbluex.liquidbounce.utils.render.RenderUtil1
    ...
    override fun drawElement(partialTicks: Float): Border? {
        ...
        if (lineValue.get()) {
            ...
            for (i in 0..(gradientAmountValue.get()-1)) {
                ...
                RenderUtil1.drawGradientSideways(barStart, -1.0, barEnd, 0.0,
                when (rainbowType) {
                    "CRainbow" -> RenderUtil1.getRainbowOpaque(cRainbowSecValue.get(), saturationValue.get(), brightnessValue.get(), i * distanceValue.get())
                    "Sky" -> RenderUtil1.SkyRainbow(i * distanceValue.get(), saturationValue.get(), brightnessValue.get())
                    "LiquidSlowly" -> ColorUtil1.LiquidSlowly(System.nanoTime(), i * distanceValue.get(), saturationValue.get(), brightnessValue.get())!!.rgb
                    "Fade" -> ColorUtil1.fade(Color(redValue.get(), greenValue.get(), blueValue.get()), i * distanceValue.get(), 100).rgb
                    else -> color
                },
                when (rainbowType) {
                    "CRainbow" -> RenderUtil1.getRainbowOpaque(cRainbowSecValue.get(), saturationValue.get(), brightnessValue.get(), (i + 1) * distanceValue.get())
                    "Sky" -> RenderUtil1.SkyRainbow((i + 1) * distanceValue.get(), saturationValue.get(), brightnessValue.get())
                    "LiquidSlowly" -> ColorUtil1.LiquidSlowly(System.nanoTime(), (i + 1) * distanceValue.get(), saturationValue.get(), brightnessValue.get())!!.rgb
                    "Fade" -> ColorUtil1.fade(Color(redValue.get(), greenValue.get(), blueValue.get()), (i + 1) * distanceValue.get(), 100).rgb
                    else -> color
                })
            }
        }

        RenderUtil1.drawRect(0F, 0F, nameLength + hpLength + distLength + 50F, 4F + font.FONT_HEIGHT.toFloat(), bgColor.rgb)
        ...
        playerList.forEachIndexed { index, player ->
            RenderUtil1.drawRect(0F, height, nameLength + hpLength + distLength + 50F, height + 2F + font.FONT_HEIGHT.toFloat(), bgColor.rgb)
