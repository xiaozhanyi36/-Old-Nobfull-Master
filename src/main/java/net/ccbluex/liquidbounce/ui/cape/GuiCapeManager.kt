...
object GuiCapeManager : GuiScreen() {
    ...
    private val cape1 = loadCapeFromResource("Cape 1", "assets/minecraft/destiny/cape/cape1.png")
    private val cape2 = loadCapeFromResource("Cape 2", "assets/minecraft/destiny/cape/cape2.png")
    private val cape3 = loadCapeFromResource("Cape 3", "assets/minecraft/destiny/cape/cape3.png")
    private val cape4 = loadCapeFromResource("Cape 4", "assets/minecraft/destiny/cape/cape4.png")
    var nowCape: Cape? = cape1
    private val capeList = mutableListOf<Cape>()
    ...
    fun load() {
        ...
        val json =
            JsonParser().parse(Files.readAllBytes(jsonFile.toPath()).toString(StandardCharsets.UTF_8)).asJsonObject
    ...
    override fun initGui() {
        this.buttonList.add(GuiButton(0, 0, 0, Fonts.font40.getStringWidth("BACK") + 10, 20, "BACK"))
        this.buttonList.add(
            GuiButton(
                1,
                (width * 0.3).toInt(),
                (height * 0.5).toInt(),
                Fonts.font40.getStringWidth("<") + 10,
                20,
                "<"
            )
        )
    ...
    override fun drawScreen(p_drawScreen_1_: Int, p_drawScreen_2_: Int, p_drawScreen_3_: Float) {
        ...
        Fonts.font40.drawCenteredString("CapeManager", width * 0.25f, height * 0.03f, -1, false)
        GL11.glPopMatrix()
