...
public final class RenderUtils3 extends MinecraftInstance {
    ...
    public static void drawImage(ResourceLocation image, double x, double y, double width, double height, int color) {
        ...
        RenderUtils3.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0f, 0.0f, (float)width, (float)height, (float)width, (float)height);
        GL11.glDepthMask(true);
        GL11.glDisable(3042);
        GL11.glEnable(2929);
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image) {
        ...
        RenderUtils3.drawModalRectWithCustomSizedTexture(x, y, 0, 0, width, height, width, height);
