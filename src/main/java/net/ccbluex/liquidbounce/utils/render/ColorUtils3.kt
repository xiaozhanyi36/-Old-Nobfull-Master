...
object ColorUtils3 {
    ...
    @JvmStatic
    fun fade(time: Long, count: Int, qd: Float, sq: Float): Color? {
    ...
    @JvmStatic
    fun rainbow(offset: Long,sau:Float, brightpass: Float): Color {
        val currentColor = Color(Color.HSBtoRGB((System.nanoTime() + offset) / 10000000000F % 1, sau, brightpass))
