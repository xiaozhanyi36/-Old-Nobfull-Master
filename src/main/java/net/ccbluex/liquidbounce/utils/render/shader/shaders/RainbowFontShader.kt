...
class RainbowFontShader : Shader("rainbow_font_shader.frag"), Closeable {
    ...
    override fun updateUniforms() {
        ...
        GL20.glUniform1f(getUniform("bright"), bright)
    }
    ...
    companion object {
        ...
        inline fun begin(enable: Boolean, x: Float, y: Float, offset: Float,bright: Float): RainbowFontShader {
