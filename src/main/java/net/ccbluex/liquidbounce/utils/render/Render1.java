...
import static net.ccbluex.liquidbounce.utils.RenderUtils.color;
...
public final class Render1 extends MinecraftInstance {
    ...
    public static void drawImage(ResourceLocation image, double x, double y, double width, double height, int color) {
        ...
        Render1.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0f, 0.0f, (float)width, (float)height, (float)width, (float)height);
        GL11.glDepthMask(true);
        GL11.glDisable(3042);
        GL11.glEnable(2929);
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image) {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("destiny/paneltop/" + image + ".png"));
        GlStateManager.color(1F, 1F, 1F, 1F);
        Render1.drawModalRectWithCustomSizedTexture(x, y, 0, 0, width, height, width, height);
