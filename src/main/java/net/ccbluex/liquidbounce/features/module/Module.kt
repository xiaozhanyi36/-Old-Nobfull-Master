...
import net.ccbluex.liquidbounce.features.module.modules.color.ArrayList
        ...
        set(value) {
            if (slideAnimation == null || (slideAnimation != null && slideAnimation!!.to != value.toDouble())) {
                slideAnimation = Animation(
                    EaseUtils.EnumEasingType.valueOf(ArrayList.arraylistXAxisAnimTypeValue.get()),
                    EaseUtils.EnumEasingOrder.valueOf(ArrayList.arraylistXAxisAnimOrderValue.get()),
                    field.toDouble(),
                    value.toDouble(),
                    ArrayList.arraylistXAxisAnimSpeedValue.get() * 30L
                ).start()
            }
        }
        ...
        set(value) {
            if (yPosAnimation == null || (yPosAnimation != null && yPosAnimation!!.to != value.toDouble())) {
                yPosAnimation = Animation(
                    EaseUtils.EnumEasingType.valueOf(ArrayList.arraylistYAxisAnimTypeValue.get()),
                    EaseUtils.EnumEasingOrder.valueOf(ArrayList.arraylistYAxisAnimOrderValue.get()),
                    field.toDouble(),
                    value.toDouble(),
                    ArrayList.arraylistYAxisAnimSpeedValue.get() * 30L
                ).start()
            }
        }
