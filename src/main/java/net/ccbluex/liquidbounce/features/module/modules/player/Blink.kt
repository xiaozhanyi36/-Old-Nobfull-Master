...
import net.ccbluex.liquidbounce.features.module.modules.render.TrailLine
...
@ModuleInfo(name = "Blink", category = ModuleCategory.PLAYER, description = "Suspends all movement packets")
class Blink : Module() {
    ...
    fun onRender3D(event: Render3DEvent) {
        val breadcrumbs = LiquidBounce.moduleManager[TrailLine::class.java]!!
        synchronized(positions) {
            GL11.glPushMatrix()
