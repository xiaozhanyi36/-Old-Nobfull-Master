...
@ModuleInfo(name = "AutoGG", category = ModuleCategory.MISC, description = "Auto send GG message")
class AutoGG : Module() {
    private val modeValue = ListValue("Mode", arrayOf("Hypixel", "HuaYuTing","Hyt16"), "HuaYuTing")
    private val messageValue = TextValue("GGMessage", "Good Game!")
