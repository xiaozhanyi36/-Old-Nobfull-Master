...
@ModuleInfo(name = "Rainbow", category = ModuleCategory.COLOR, canEnable = false, description = "Rainbow settings")
object Rainbow: Module() {
    val rainbowStart = FloatValue("Start", 0.0f, 0f, 1f)
    val rainbowStop = FloatValue("Stop", 1.0f, 0f, 1f)
