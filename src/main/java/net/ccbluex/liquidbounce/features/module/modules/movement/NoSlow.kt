...
class NoSlow : Module() {
    ...
    private val modeValue = ListValue("PacketMode", arrayOf("AntiCheat","Custom","Hypixel","NoCheatPlus","NoPacket","AAC","AAC5", "Matrix", "Vulcan", "Medusa", "WatchDog","Hypixel1"), "AntiCheat")
